...
logger = logging
model_file = 'cls_model.onnx'


class TextClassifier(object):
    def __init__(self, label_list=('0', '180'), cls_batch_num=6, cls_thresh=0.9, ort_providers=None,thread_num=2):
        ...
        so.intra_op_num_threads = thread_num
        sess = ort.InferenceSession(get_model_data(model_file), so, providers=ort_providers)
